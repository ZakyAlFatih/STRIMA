...
if itemtotal > 0:
    ...
    # Measure execution time for greedy algorithms
    def measure_greedy_time():
        greedy_algorithm(items_data, max_capacity, "weight")
        greedy_algorithm(items_data, max_capacity, "profit")
        greedy_algorithm(items_data, max_capacity, "density")
